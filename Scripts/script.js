const quotes = [
    "Sometimes you will never know the value of a moment, until it becomes <br> a memory.",
    "Be careful who you make memories with. Those things can last a lifetime.",
    "It is often not the words but the message behind the words that makes <br> a quote so meaningful",
];
